...
<body x-data="{ isOpen: false, selectedDetail: {} }">
                    ...
                    @foreach ($data as $e)
                        <li class="flex justify-between gap-x-6 py-5">
                            ...
                            <div
                                ...
                                <div>
                                    <button class="bg-orange-400 p-2 rounded-full hover:animate-spin "
                                        @click.prevent="isOpen = true; selectedDetail = {{ json_encode($e) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px"
                                            viewBox="0 -960 960 960" width="24px" fill="#000000">
                                            <path
